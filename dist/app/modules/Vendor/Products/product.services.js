...
const deleteProductFromDB = (product_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getAllProductsFromDB = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getSingleProductFromDB = (p_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const duplicateProductFromDB = (p_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const { id } = existingProduct,
        productData = __rest(existingProduct, ["id"]);
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const simplifiedReviews = result.map((review) => {
      ...
      return {
        ...
        username:
          ((_a = review.customer) === null || _a === void 0
            ? void 0
            : _a.name) || "Anonymous",
        image:
          ((_b = review.customer) === null || _b === void 0
            ? void 0
            : _b.image) || null,
      };
    });
