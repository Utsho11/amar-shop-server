...
const createOrderIntoDB = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const payload = req.body;
    const { OrderItem } = payload,
      rest = __rest(payload, ["OrderItem"]);
    ...
    const order = yield prisma_1.default.$transaction((transactionClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(
          orderItemPayload.map((orderItem) =>
            __awaiter(void 0, void 0, void 0, function* () {
        ...
        const customerData = {
          name:
            customerDetails === null || customerDetails === void 0
              ? void 0
...
const getItemForReviewFromDB = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getMyOrderHistoryFromDB = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cus_email = req.user.email;
    ...
    const structuredOrders = orders.map((item) => {
      ...
      return {
        ...
        transactionId:
          ((_a = item.order.Transaction[0]) === null || _a === void 0
            ? void 0
            : _a.transactionId) || null,
      };
    });
